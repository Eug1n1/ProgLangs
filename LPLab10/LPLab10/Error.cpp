...
namespace Error
{
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY_NODEF(111, "Недопустимый символ в исходном файле (-in)"),
		ERROR_ENTRY_NODEF(112, "Ошибка при создании файла протокола (-log)"),
